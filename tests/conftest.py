    ...
    config = {
        ...
        "alarms": [
            ...
            },
            {
                ...
                "service_impact": "Cell outage",
                "probable_cause": "PTP drift",
            },
            {
            ...
            {"name": "ptp_drift", "layer": 1, "source": "ran", "field": "ptp_offset_ns", "condition": "> 1500", "severity": "critical", "depends_on": [], "nf_scope": "per-node"},
        ],
        "guardrails": {
