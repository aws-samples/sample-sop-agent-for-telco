...
class TestEnvironmentScanners:
    ...
    def test_scan_core_returns_pods(self, mock_run):
        ...
        from amzn_cse_telco_autonomous_network_agents_app.agent.monitor import _scan_environment
    ...
    def test_scan_ue_returns_logs(self, mock_run):
        ...
        from amzn_cse_telco_autonomous_network_agents_app.agent.monitor import _alarm_ref, _scan_environment
...
class TestSOPEnrichment:
    ...
    def test_enrichment_calls_scan(self, mock_scan):
        ...
        from amzn_cse_telco_autonomous_network_agents_app.agent.monitor import _enrich_sop
