...
from amzn_cse_telco_autonomous_network_agents_app.agent.cluster import check_source_status
...
def build_monitoring_stats_payload() -> dict:
    ...
    try:
        from amzn_cse_telco_autonomous_network_agents_app.agent.monitor import BEDROCK_CLASSIFY_COOLDOWN, _alarm_ref, _baselines
